...
#define NPC_D_MON_CSD_VIDEO_FRAME_TYPE_VI							4				//VI帧
#define NPC_D_MON_CSD_VIDEO_FRAME_TYPE_PB							5				//PB帧
...
#ifndef NPC_D_TDKS
#define NPC_D_MON_CSD_ALARM_EVENT_BLACK_MODE						22              //黑名单报警
#define NPC_D_MON_CSD_ALARM_EVENT_WHILE_MODE						23              //白名单报警
#define NPC_D_MON_CSD_ALARM_EVENT_NON_WHILE_MODE					24              //非白名单报警
#define NPC_D_MON_CSD_ALARM_EVENT_TARGET_COUNT						25				//目标计数报警
#define NPC_D_MON_CSD_ALARM_EVENT_TEMPERATURE						26				//温度报警
#define NPC_D_MON_CSD_ALARM_EVENT_SOUND								27				//声音报警
#else
#define NPC_D_MON_CSD_ALARM_EVENT_SMART_IPC_DEFOCUS             		22              //虚焦侦测报警
#define NPC_D_MON_CSD_ALARM_EVENT_SUDDENSCENE_CHANGE					23				//场景变更报警
#define NPC_D_MON_CSD_ALARM_EVENT_SMART_IPC_AUDIO_INPUT_EXCEPTION		24              //音频输入异常报警
#define NPC_D_MON_CSD_ALARM_EVENT_SMART_IPC_SOUND_INTENSITY_MUTATION	25              //声强突变报警
#define NPC_D_MON_CSD_ALARM_EVENT_SMART_IPC_SOUND_INTENSITY_STEEP_RISE	26              //声强陡升报警
#define NPC_D_MON_CSD_ALARM_EVENT_SMART_IPC_SOUND_INTENSITY_STEEP_FALL	27              //声强陡降报警
#endif

#define NPC_D_MON_CSD_ALARM_EVENT_VIP_MODE							28              //VIP报警
#define NPC_D_MON_CSD_ALARM_EVENT_STRANGER							29              //陌生人报警
#define NPC_D_MON_CSD_ALARM_EVENT_PERSON_ALERT						30				//人员提醒
#define NPC_D_MON_CSD_ALARM_EVENT_VEHICLE_ALERT						31				//车辆提醒
#define NPC_D_MON_CSD_ALARM_EVENT_VISITOR_CALL						32				//访客呼叫
...
//播放速度控制
#define NPC_D_MON_CSD_PLAYBACK_SPEED_DEFAULT						0				//正常速度
#define NPC_D_MON_CSD_PLAYBACK_SPEED_TWO							1				//2倍速
#define NPC_D_MON_CSD_PLAYBACK_SPEED_FOUR							2				//4倍速
#define	NPC_D_MON_CSD_PLAYBACK_SPEED_EIGTH							3				//8倍速
#define	NPC_D_MON_CSD_PLAYBACK_SPEED_SIXTEEN						4				//16倍速
#define	NPC_D_MON_CSD_PLAYBACK_SPEED_THIRTYTWO						5				//32倍速
